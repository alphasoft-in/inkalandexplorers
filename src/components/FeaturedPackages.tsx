                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-auto">
                    ...
                    <a 
                      ...
                      className="block w-full bg-[#0b403a] text-white text-center py-3 rounded-xl font-bold hover:bg-[#dfa126] hover:text-[#0b403a] transition-all duration-300 uppercase tracking-widest text-[10px] flex items-center justify-center gap-2 shadow-lg shadow-[#0b403a]/20"
                    >
